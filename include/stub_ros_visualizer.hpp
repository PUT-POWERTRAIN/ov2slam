/**
* Stub for ros_visualizer.hpp - Allows building OV2SLAM without ROS
* This replaces all ROS dependencies with minimal stubs
*/

#ifndef STUB_ROS_VISUALIZER_HPP
#define STUB_ROS_VISUALIZER_HPP
...
public:
    ...
    RosVisualizer(ros::NodeHandle& n) {
        std::cout << "\n[Standalone] Visualizer created (no ROS required)\n";
        ...
        std::cout << "[Standalone] Results will be saved to:\n";
    ...
    ~RosVisualizer() {
        ...
        std::cout << "\n[Standalone] Visualizer closed, trajectories saved\n";
    }
